                                            ...
                                            return (
                                                <ListItem key={i}>
                                                    <div className="wrapper-result__line">
                                                        <input className="chk-course" type="checkbox" defaultChecked={false} onClick={(el)=>this.toogleChart(el, data)}/><img src={image?`${process.env.REACT_APP_BACKEND}public/${image}`:null} alt={image?image:null}/>
